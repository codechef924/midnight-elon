          ...
          (function (t, e, n, o) {
            ...
            let y = (function (t, e, n) {
                ...
                let a = r.getSymbolTotalCodewords(t),
                  ...
                  u = (a - l) * 8;
                for (
                  o.getLengthInBits() + 4 <= u && o.put(0, 4);
            ...
            return (
              ...
              isNaN(o) && (o = s.getBestMask(A, m.bind(null, A, n))),
              s.applyMask(o, A),
              m(A, n, o),
              {
                modules: A,
              ...
              for (let n = 0; n < t.length; n++) {
                ...
                switch (o.mode) {
                  ...
                  case r.KANJI:
                    e.push([
                      o,
                      { data: o.data, mode: r.BYTE, length: c(o.data) },
                    ]);
                    break;
                  case r.BYTE:
                    e.push([{ data: o.data, mode: r.BYTE, length: c(o.data) }]);
                }
              }
              return e;
            })(o),
            a = (function (t, e) {
              ...
              for (let a = 0; a < t.length; a++) {
                ...
                for (let t = 0; t < l.length; t++) {
                  let s = l[t],
                    f = "" + a + t;
                  u.push(f), (n[f] = { node: s, lastCount: 0 }), (o[f] = {});
                  for (let t = 0; t < i.length; t++) {
                    let a = i[t];
                    n[a] && n[a].node.mode === s.mode
                      ? ((o[a][f] =
                          d(n[a].lastCount + s.length, s.mode) -
                          d(n[a].lastCount, s.mode)),
