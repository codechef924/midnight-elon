  ...
  [6909],
  {
    56909: function (e, t, r) {
      ...
      (y[b] = !0),
        ...
        (null !== (eb = m.reactiveElementVersions) && void 0 !== eb
          ? eb
...
\f\r"'\`<>=]|("|')|))|$)`,
        ...
        constructor({ strings: e, _$litType$: t }, r) {
          ...
          for (; null !== (i = F.nextNode()) && n.length < a; ) {
            if (1 === i.nodeType) {
              ...
              if (i.data === k) n.push({ type: 2, index: o });
              else {
                let e = -1;
        ...
        return (
          (null == s ? void 0 : s.constructor) !== c &&
            (null === (l = null == s ? void 0 : s._$AO) ||
              void 0 === l ||
              l.call(s, !1),
            void 0 === c ? (s = void 0) : (s = new c(e))._$AT(e, r, i),
            void 0 !== i
              ? ((null !== (a = (n = r)._$Co) && void 0 !== a
                  ? a
                  : (n._$Co = []))[i] = s)
              : (r._$Cl = s)),
          void 0 !== s && (t = G(e, s._$AS(e, t.values), s, i)),
          t
        );
      }
      class X {
          ...
          let { values: r, _$litType$: i } = e,
            o =
              "number" == typeof i
                ? this._$AC(e)
                : (void 0 === i.el &&
                    (i.el = Q.createElement(K(i.h, i.h[0]), this.options)),
                  i);
          if (
      ...
      class ee {
        ...
        _$AI(e, t = this, r, i) {
          let o = this.strings,
            l = !1;
          if (void 0 === o)
            (l = !T((e = G(this, e, t, 0))) || (e !== this._$AH && e !== Z)) &&
              (this._$AH = e);
          else {
            let i, a;
            let n = e;
            for (e = o[0], i = 0; i < o.length - 1; i++)
              (a = G(this, n[r + i], t, i)) === Z && (a = this._$AH[i]),
      ...
      class eo extends ee {
        ...
        _$AI(e, t = this) {
          var r;
          if (
            (e = null !== (r = G(this, e, t, 0)) && void 0 !== r ? r : V) === Z
          )
            return;
          let i = this._$AH,
            o =
      ...
      null == ea || ea(Q, J),
        (null !== (ey = x.litHtmlVersions) && void 0 !== ey
          ? ey
          : (x.litHtmlVersions = [])
        ).push("2.8.0");
      let en = (e, t, r) => {
      ...
      (es.finalized = !0),
        (es._$litElement$ = !0),
        null === (ex = globalThis.litElementHydrateSupport) ||
          void 0 === ex ||
          ex.call(globalThis, { LitElement: es });
      ...
      null !=
        (null === (eC = window.HTMLSlotElement) || void 0 === eC
          ? void 0
          : eC.prototype.assignedElements) ||
        ((e, t) =>
      ...
      let eT = (e) => e(),
        eP = (e, t, r = e_.duration) =>
          new Proxy(
            { animations: e.map(eT).filter(Boolean), duration: r, options: t },
            eR
          ),
        eM = (e) => e.animations[0],
        eR = {
      ...
      function eZ(e, t, r, i) {
        ...
        let o = (t) =>
          (function (e, t, r, i, o) {
            ...
            let n = 0;
            do
              (l = eB((a = t + (r - t) / 2), i, o) - e) > 0 ? (r = a) : (t = a);
      ...
      function e1(e) {
        return (
          e0.has(e) || e0.set(e, { transforms: [], values: new Map() }),
          e0.get(e)
        );
      }
      let e2 = ["", "X", "Y", "Z"],
        e5 = { x: "translateX", y: "translateY", z: "translateZ" },
        e3 = {
          syntax: "<angle>",
          initialValue: "0deg",
      ...
      ["translate", "scale", "rotate", "skew"].forEach((e) => {
        e2.forEach((t) => {
          e8.push(e + t), e7.set(e6(e + t), e4[e]);
        });
      });
      let e9 = (e, t) => e8.indexOf(e) - e8.indexOf(t),
        ...
        tr = (e, t) => {
          var r;
          e5[t] && (t = e5[t]);
          let { transforms: i } = e1(e);
          (r = t),
            -1 === i.indexOf(r) && i.push(r),
            (e.style.transform = ti(i));
        },
        ...
        ts = {
          ...
          finished: () =>
            Boolean(tn({ opacity: [0, 1] }, { duration: 0.001 }).finished),
          linearEasing: () => {
            try {
              tn({ opacity: 0 }, { easing: "linear(0, 1)" });
            } catch (e) {
              return !1;
            }
            return !0;
        ...
        td = {};
      for (let e in ts)
        td[e] = () => (void 0 === tc[e] && (tc[e] = ts[e]()), tc[e]);
      let th = (e, t) => {
          let r = "",
      ...
      let tg = {
        ...
        tb = function (e, t, r = {}) {
          ...
          "string" == typeof (i = e)
            ...
            (e = Array.from(i || []));
          let s = e.length;
          (0, eX.k)(Boolean(s), "No valid element provided."),
            (0, eX.k)(Boolean(t), "No keyframes defined.");
          let c = [];
          for (let i = 0; i < s; i++) {
            let o = e[i];
            for (let e in t) {
              ...
              let d = (function (e, t, r, i = {}, o) {
                ...
                let x = tw(t),
                  ...
                  C = e7.get(x);
                return (
                  eI($.animation, !(eL(p) && $.generator) && !1 !== i.record),
                  () => {
                    let l = () => {
                        var t, r;
                        return null !==
                          (r =
                            null !== (t = tg.get(e, x)) && void 0 !== t
                              ? t
                              : null == C
                              ? void 0
                              : C.initialValue) && void 0 !== r
                          ? r
                          : 0;
                      },
                      f = (function (e, t) {
                    ...
                    if (
                      (tl(x) &&
                        (td.cssRegisterProperty()
                          ? (function (e) {
                              if (!ta.has(e)) {
                                ta.add(e);
                                try {
                                  let { syntax: t, initialValue: r } = e7.has(e)
                                    ? e7.get(e)
                                    : {};
                      ...
                      C && (f = f.map((e) => (eW(e) ? C.toDefaultUnit(e) : e))),
                        1 === f.length &&
                          (!td.partialKeyframes() || s) &&
                          f.unshift(l());
                      let t = {
                        delay: ek.ms(d),
                        duration: ek.ms(c),
      ...
      var tC = r(92592),
        ...
        tI = (e, t) => {
          ...
          if (t_) for (var r of t_(t)) tO.call(t, r) && tE(e, r, t[r]);
          return e;
        };
      function tT() {
        return {
      ...
      let tW = class extends es {
        ...
        render() {
          ...
          return (
            ...
            H`<button class="${ev(e)}" ?disabled="${this.disabled}" @click="${
              this.onClick
            }">${
              this.iconLeft
      ...
      (tW.styles = [tP.globalCss, tM]),
        tL([ep({ type: Boolean })], tW.prototype, "disabled", 2),
        tL([ep()], tW.prototype, "iconLeft", 2),
        tL([ep()], tW.prototype, "iconRight", 2),
        tL([ep()], tW.prototype, "onClick", 2),
        tL([ep()], tW.prototype, "variant", 2),
        (tW = tL([ed("wcm-button")], tW));
      ...
      var tD = Object.defineProperty,
        ...
        tz = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tN(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let tU = class extends es {
        ...
        render() {
          ...
          return H`<button ?disabled="${this.disabled}" class="${ev(
            e
          )}"><slot></slot></button>`;
        }
      };
      (tU.styles = [tP.globalCss, tj]),
        tz([ep({ type: Boolean })], tU.prototype, "disabled", 2),
        tz([ep()], tU.prototype, "variant", 2),
        (tU = tz([ed("wcm-button-big")], tU));
      ...
      (tQ.styles = [tP.globalCss, tF]),
        (tQ = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tY(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let t3 = class extends es {
        render() {
          return H`<footer><slot></slot></footer>`;
        }
      };
      (t3.styles = [tP.globalCss, t1]),
        (t3 = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? t5(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && t2(t, r, l), l;
        })([ed("wcm-modal-footer")], t3));
      let t4 = c`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
      var t7 = Object.defineProperty,
        t6 = Object.getOwnPropertyDescriptor,
        t8 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? t6(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
        ...
        render() {
          let e = { "wcm-border": this.border },
            ...
            r = this.title
              ...
              : H`<slot></slot>`;
          return H`<header class="${ev(e)}">${
            t ? this.backBtnTemplate() : null
          } ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
        }
      };
      (t9.styles = [tP.globalCss, t4]),
        t8([ep()], t9.prototype, "title", 2),
        t8([ep()], t9.prototype, "onAction", 2),
        t8([ep()], t9.prototype, "actionIcon", 2),
        t8([ep({ type: Boolean })], t9.prototype, "border", 2),
        (t9 = t8([ed("wcm-modal-header")], t9));
      let re = {
          ...
          getWalletIcon({ id: e, image_id: t }) {
            let { walletImages: r } = eA.t0.state;
            return null != r && r[e]
              ? r[e]
              : t
              ? eA.uc.getWalletImageUrl(t)
              : "";
          },
          getWalletName: (e, t = !1) =>
          ...
          handleMobileLinking(e) {
            let t;
            let { walletConnectUri: r } = eA.zb.state,
              { mobile: i, name: o } = e,
              l = i?.native,
              a = i?.universal;
            re.setRecentWallet(e),
              r &&
                ((t = ""),
                l
                  ? (t = eA.zv.formatUniversalUrl(l, r, o))
                  : a && (t = eA.zv.formatNativeUrl(a, r, o)),
                eA.zv.openHref(t, "_self"));
          },
          handleAndroidLinking() {
            let { walletConnectUri: e } = eA.zb.state;
            e &&
              (eA.zv.setWalletConnectAndroidDeepLink(e),
              eA.zv.openHref(e, "_self"));
          },
          async handleUriCopy() {
            let { walletConnectUri: e } = eA.zb.state;
            if (e)
              try {
                await navigator.clipboard.writeText(e),
                  eA.Vs.openToast("Link copied", "success");
              } catch {
                eA.Vs.openToast("Failed to copy", "error");
              }
          },
          getCustomImageUrls() {
            let { walletImages: e } = eA.t0.state,
              t = Object.values(e ?? {});
          ...
          getCachedRouterWalletPlatforms() {
            let { desktop: e, mobile: t } = eA.zv.getWalletRouterData(),
              r = Boolean(e?.native),
              i = Boolean(e?.universal),
              o = Boolean(t?.native) || Boolean(t?.universal);
            return { isDesktop: r, isMobile: o, isWeb: i };
          },
          goToConnectingView(e) {
            eA.AV.setData({ Wallet: e });
            ...
            t
              ? o
                ? eA.AV.push("MobileConnecting")
                : i
                ? eA.AV.push("WebConnecting")
                : eA.AV.push("InstallWallet")
              : r
              ? eA.AV.push("DesktopConnecting")
              : i
              ? eA.AV.push("WebConnecting")
              : o
              ? eA.AV.push("MobileQrcodeConnecting")
              : eA.AV.push("InstallWallet");
          },
        },
      ...
      var rr = Object.defineProperty,
        ...
        ro = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ri(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rl = class extends es {
        constructor() {
          super(),
            (this.view = eA.AV.state.view),
            (this.prevView = eA.AV.state.view),
            (this.unsubscribe = void 0),
            (this.oldHeight = "0px"),
            (this.resizeObserver = void 0),
            (this.unsubscribe = eA.AV.subscribe((e) => {
      ...
      (rl.styles = [tP.globalCss, rt]),
        ro([eu()], rl.prototype, "view", 2),
        ro([eu()], rl.prototype, "prevView", 2),
        (rl = ro([ed("wcm-modal-router")], rl));
      ...
      let rd = class extends es {
        constructor() {
          super(),
            ...
            (this.unsubscribe = void 0),
            (this.timeout = void 0),
            (this.unsubscribe = eA.Vs.subscribe((e) => {
              e.open
                ? ((this.open = !0),
                  (this.timeout = setTimeout(() => eA.Vs.closeToast(), 2200)))
        ...
        render() {
          let { message: e, variant: t } = eA.Vs.state;
          return this.open
            ? H`<div class="${ev({
                "wcm-success": "success" === t,
                "wcm-error": "error" === t,
              })}">${"success" === t ? tq.CHECKMARK_ICON : null} ${
                "error" === t ? tq.CROSS_ICON : null
      ...
      (rd.styles = [tP.globalCss, ra]),
        rc([eu()], rd.prototype, "open", 2),
        (rd = rc([ed("wcm-modal-toast")], rd));
      let rm = {
          generate(e, t, r) {
            let i = "#141414",
              o = [],
              l = (function (e, t) {
                let r = Array.prototype.slice.call(
                    tC.create(e, { errorCorrectionLevel: "Q" }).modules.data,
                    0
                  ),
            ...
            return (
              ...
              Object.entries(m)
                ...
                .forEach(([e, t]) => {
                  t.forEach((t) => {
                    o.push(
                      B`<circle cx="${e}" cy="${t}" fill="${i}" r="${a / 2.5}">`
                    );
                  });
                }),
              Object.entries(m)
                ...
                .forEach(([e, t]) => {
                  t.forEach(([t, r]) => {
                    o.push(
                      B`<line x1="${e}" x2="${e}" y1="${t}" y2="${r}" stroke="${i}" stroke-width="${
                        a / 1.25
      ...
      var ru = Object.defineProperty,
        ...
        rg = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rw(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rv = class extends es {
        ...
        svgTemplate() {
          let e =
            "light" === eA.Ic.state.themeMode ? this.size : this.size - 36;
          return B`<svg height="${e}" width="${e}">${rm.generate(
            this.uri,
            e,
            e / 4
          )}</svg>`;
        ...
        render() {
          let e = { "wcm-dark": "dark" === eA.Ic.state.themeMode };
          return H`<div style="${`width: ${this.size}px`}" class="${ev(e)}">${
            this.walletId || this.imageUrl
              ? H`<wcm-wallet-image walletId="${t$(
                  this.walletId
                )}" imageId="${t$(this.imageId)}" imageUrl="${t$(
                  this.imageUrl
                )}"></wcm-wallet-image>`
              : tq.WALLET_CONNECT_ICON_COLORED
          } ${this.svgTemplate()}</div>`;
        }
      };
      (rv.styles = [tP.globalCss, rp]),
        rg([ep()], rv.prototype, "uri", 2),
        rg([ep({ type: Number })], rv.prototype, "size", 2),
        rg([ep()], rv.prototype, "imageId", 2),
        rg([ep()], rv.prototype, "walletId", 2),
        rg([ep()], rv.prototype, "imageUrl", 2),
        (rv = rg([ed("wcm-qrcode")], rv));
      ...
      (r$.styles = [tP.globalCss, rf]),
        rx([ep()], r$.prototype, "onChange", 2),
        (r$ = rx([ed("wcm-search-input")], r$));
      ...
      (rk.styles = [tP.globalCss, rC]),
        (rk = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? r_(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      (rP.styles = [tP.globalCss, rO]),
        rT([ep()], rP.prototype, "variant", 2),
        rT([ep()], rP.prototype, "color", 2),
        (rP = rT([ed("wcm-text")], rP));
      ...
      let rW = class extends es {
        ...
        handleClick() {
          eA.uA.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
            this.onClick();
        }
        render() {
          var e;
          return H`<button @click="${this.handleClick.bind(
            this
          )}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${t$(
            this.imageId
          )}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${
            null != (e = this.label) ? e : re.getWalletName(this.name, !0)
          }</wcm-text>${this.sublabelTemplate()}</div></button>`;
        }
      };
      (rW.styles = [tP.globalCss, rM]),
        rL([ep()], rW.prototype, "onClick", 2),
        rL([ep()], rW.prototype, "name", 2),
        rL([ep()], rW.prototype, "walletId", 2),
        rL([ep()], rW.prototype, "label", 2),
        rL([ep()], rW.prototype, "imageId", 2),
        rL([ep({ type: Boolean })], rW.prototype, "installed", 2),
        rL([ep({ type: Boolean })], rW.prototype, "recent", 2),
        (rW = rL([ed("wcm-wallet-button")], rW));
        ...
        render() {
          ...
          let t =
            null != (e = this.imageUrl) && e.length
              ? this.imageUrl
              : re.getWalletIcon({ id: this.walletId, image_id: this.imageId });
          return H`${
            t.length
              ? H`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`
              : tq.WALLET_PLACEHOLDER
          }`;
        }
      };
      (rU.styles = [tP.globalCss, rj]),
        rz([ep()], rU.prototype, "walletId", 2),
        rz([ep()], rU.prototype, "imageId", 2),
        rz([ep()], rU.prototype, "imageUrl", 2),
        (rU = rz([ed("wcm-wallet-image")], rU));
      ...
      let rV = class extends es {
        ...
        async loadImages(e) {
          try {
            null != e &&
              e.length &&
              (await Promise.all(e.map(async (e) => re.preloadImage(e))));
          } catch {
        ...
        async preloadListings() {
          if (eA.t0.state.enableExplorer) {
            ...
            let { recomendedWallets: e } = eA.uc.state,
              t = e.map((e) => re.getWalletIcon(e));
      ...
      rZ([eu()], rV.prototype, "preload", 2),
        (rV = rZ([ed("wcm-explorer-context")], rV));
      ...
      let rK = class extends es {
        constructor() {
          super(),
            ...
            tP.setTheme(),
            (this.unsubscribeTheme = eA.Ic.subscribe(tP.setTheme));
        }
        disconnectedCallback() {
          var e;
      ...
      let rX = class extends es {
        ...
        render() {
          let { recomendedWallets: e } = eA.uc.state,
            t = [...e, ...e],
            r = 2 * eA.zv.RECOMMENDED_WALLET_AMOUNT;
      ...
      (rX.styles = [tP.globalCss, rY]),
        (rX = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rG(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      var r0 = Object.defineProperty,
        ...
        r2 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? r1(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let r5 = class extends es {
        ...
        svgLoaderTemplate() {
          ...
          let r =
              null !=
              (t =
                null == (e = eA.Ic.state.themeVariables)
                  ? void 0
                  : e["--wcm-wallet-icon-large-border-radius"])
                ? t
                : tP.getPreset("--wcm-wallet-icon-large-border-radius"),
            i = 0;
          i =
        ...
        render() {
          ...
          return H`<div class="${ev(
            e
          )}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${t$(
            this.walletId
          )}" imageId="${t$(
            this.imageId
      ...
      (r5.styles = [tP.globalCss, rJ]),
        r2([ep()], r5.prototype, "walletId", 2),
        r2([ep()], r5.prototype, "imageId", 2),
        r2([ep({ type: Boolean })], r5.prototype, "isError", 2),
        r2([ep({ type: Boolean })], r5.prototype, "isStale", 2),
        r2([ep()], r5.prototype, "label", 2),
        (r5 = r2([ed("wcm-connector-waiting")], r5));
      let r3 = {
          manualWallets() {
            var e, t;
            let { mobileWallets: r, desktopWallets: i } = eA.t0.state,
              o = null == (e = r3.recentWallet()) ? void 0 : e.id,
              l = eA.zv.isMobile() ? r : i,
              a = l?.filter((e) => o !== e.id);
            return null !=
              (t = eA.zv.isMobile()
          ...
          recomendedWallets(e = !1) {
            var t;
            let r = e || null == (t = r3.recentWallet()) ? void 0 : t.id,
              { recomendedWallets: i } = eA.uc.state;
        ...
        r4 = {
          ...
          recentWalletTemplate() {
            let e = r3.recentWallet();
            if (e)
              return H`<wcm-wallet-button name="${e.name}" walletId="${
                e.id
              }" imageId="${t$(e.image_id)}" .recent="${!0}" .onClick="${() =>
                this.onConnecting(e)}"></wcm-wallet-button>`;
          },
        },
      ...
      let r9 = class extends es {
        render() {
          let { explorerExcludedWalletIds: e, enableExplorer: t } = eA.t0.state,
            r = r4.manualWalletsTemplate(),
            i = r4.recomendedWalletsTemplate(),
            o = [r4.recentWalletTemplate(), ...r, ...i];
          o = o.filter(Boolean);
      ...
      (r9.styles = [tP.globalCss, r7]),
        (r9 = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? r8(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let ii = class extends es {
        render() {
          let { termsOfServiceUrl: e, privacyPolicyUrl: t } = eA.t0.state;
          return e ?? t
      ...
      (ii.styles = [tP.globalCss, ie]),
        (ii = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ir(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let is = class extends es {
        ...
        render() {
          ...
          return H`<wcm-modal-header title="Connect your wallet" .onAction="${
            this.onQrcode
          }" .actionIcon="${tq.QRCODE_ICON}"></wcm-modal-header>${
            n
      ...
      let ip = class extends es {
        constructor() {
          super(),
            ...
            (this.unsubscribeModal = eA.jb.subscribe((e) => {
          ...
          this.toggleBodyScroll(!1),
            ...
            setTimeout(async () => {
              ...
              await Promise.all([
                ...
                tx(this.containerEl, e, { delay: 0.1, duration: 0.2 }).finished,
              ]),
                (this.active = !0);
            }, 0);
        }
        async onCloseModalEvent() {
          ...
          let e = re.isMobileAnimation()
            ...
            : { scale: [1, 0.98] };
          await Promise.all([
            tx(this.overlayEl, { opacity: [1, 0] }, { duration: 0.2 }).finished,
            tx(this.containerEl, e, { duration: 0.2 }).finished,
          ]),
        ...
        render() {
          ...
          return H`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${ev(
            e
          )}" @click="${
            this.onCloseModal
      ...
      (ip.styles = [tP.globalCss, ic]),
        im([eu()], ip.prototype, "open", 2),
        im([eu()], ip.prototype, "active", 2),
        (ip = im([ed("wcm-modal")], ip));
      ...
      var iw = Object.defineProperty,
        ...
        iv = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ig(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let ib = class extends es {
        ...
        onMobile() {
          eA.zv.isMobile()
            ? eA.AV.replace("MobileConnecting")
            : eA.AV.replace("MobileQrcodeConnecting");
        }
        onDesktop() {
        ...
        render() {
          return H`<div>${this.isRetry ? H`<slot></slot>` : null} ${
            this.isMobile
              ? H`<wcm-button .onClick="${this.onMobile}" .iconLeft="${tq.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
              : null
          } ${
            this.isDesktop
              ? H`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${tq.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
              : null
          } ${
            this.isWeb
              ? H`<wcm-button .onClick="${this.onWeb}" .iconLeft="${tq.GLOBE_ICON}" variant="outline">Web</wcm-button>`
              : null
          }</div>`;
        }
      };
      (ib.styles = [tP.globalCss, iu]),
        iv([ep({ type: Boolean })], ib.prototype, "isMobile", 2),
        iv([ep({ type: Boolean })], ib.prototype, "isDesktop", 2),
        iv([ep({ type: Boolean })], ib.prototype, "isWeb", 2),
        iv([ep({ type: Boolean })], ib.prototype, "isRetry", 2),
        (ib = iv([ed("wcm-platform-selection")], ib));
      ...
      let iC = class extends es {
        ...
        render() {
          ...
          return H`<button @click="${
            ...
            let t = re.getWalletIcon(e);
            if (t) return H`<img crossorigin="anonymous" src="${t}">`;
            let r = re.getWalletIcon({ id: e.id });
            return r
      ...
      (iC.styles = [tP.globalCss, iy]),
        (iC = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i$(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          ...
          return H`<div class="wcm-qr-container">${
            this.uri
              ? H`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
                  this.uri
                }" walletId="${t$(this.walletId)}" imageId="${t$(
                  this.imageId
                )}"></wcm-qrcode>`
      ...
      let iW = class extends es {
        ...
        onFormatAndRedirect(e) {
          let { desktop: t, name: r } = eA.zv.getWalletRouterData(),
            i = t?.native;
          if (i) {
        ...
        openDesktopApp() {
          let { walletConnectUri: e } = eA.zb.state,
            t = eA.zv.getWalletRouterData();
          re.setRecentWallet(t), e && this.onFormatAndRedirect(e);
        }
        render() {
          let { name: e, id: t, image_id: r } = eA.zv.getWalletRouterData(),
            { isMobile: i, isWeb: o } = re.getCachedRouterWalletPlatforms();
          return H`<wcm-modal-header title="${e}" .onAction="${
            re.handleUriCopy
          }" .actionIcon="${
            tq.COPY_ICON
          }"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${t$(
            r
      ...
      (iW.styles = [tP.globalCss, iM]),
        iL([eu()], iW.prototype, "isError", 2),
        (iW = iL([ed("wcm-desktop-connecting-view")], iW));
      ...
      let iz = class extends es {
        ...
        render() {
          ...
          return H`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${t$(
            r
      ...
      (iz.styles = [tP.globalCss, ij]),
        (iz = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iN(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      var iH = Object.defineProperty,
        ...
        iZ = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iB(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let iV = class extends es {
        ...
        onFormatAndRedirect(e, t = !1) {
          let { mobile: r, name: i } = eA.zv.getWalletRouterData(),
            o = r?.native,
            l = r?.universal;
          if (o && !t) {
        ...
        openMobileApp(e = !1) {
          let { walletConnectUri: t } = eA.zb.state,
            r = eA.zv.getWalletRouterData();
        ...
        render() {
          let {
            ...
            { isWeb: l } = re.getCachedRouterWalletPlatforms(),
            a = i?.ios,
            n = o?.universal;
          return H`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${t$(
            r
            ...
            n
              ...
              : null
          }</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${t$(
            r
      ...
      (iV.styles = [tP.globalCss, iU]),
        iZ([eu()], iV.prototype, "isError", 2),
        (iV = iZ([ed("wcm-mobile-connecting-view")], iV));
      ...
      let iY = class extends es {
        render() {
          let { name: e, id: t, image_id: r } = eA.zv.getWalletRouterData(),
            { isDesktop: i, isWeb: o } = re.getCachedRouterWalletPlatforms();
          return H`<wcm-modal-header title="${e}" .onAction="${
            re.handleUriCopy
          }" .actionIcon="${
            tq.COPY_ICON
          }"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${t}" imageId="${t$(
            r
      ...
      var i0 = Object.defineProperty,
        ...
        i2 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i1(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let i5 = class extends es {
        constructor() {
          super(...arguments),
            (this.loading = !eA.uc.state.wallets.listings.length),
            (this.firstFetch = !eA.uc.state.wallets.listings.length),
            (this.search = ""),
            (this.endReached = !1),
            (this.intersectionObserver = void 0),
            (this.searchDebounce = re.debounce((e) => {
              e.length >= 1
                ? ((this.firstFetch = !0),
                  (this.endReached = !1),
                  (this.search = e),
        ...
        isLastPage() {
          let { wallets: e, search: t } = eA.uc.state,
            { listings: r, total: i } = this.search ? t : e;
          return i <= 40 || r.length >= i;
        }
        async fetchWallets() {
          var e;
          let { wallets: t, search: r } = eA.uc.state,
          ...
          if (!this.endReached && (this.firstFetch || (o > 40 && i.length < o)))
            try {
              ...
              let t = null == (e = eA.zb.state.chains) ? void 0 : e.join(","),
                { listings: r } = await eA.uc.getWallets({
              ...
              await Promise.all([
                ...i.map(async (e) => re.preloadImage(e)),
                eA.zv.wait(300),
              ]),
                (this.endReached = this.isLastPage());
            } catch (e) {
        ...
        render() {
          let { wallets: e, search: t } = eA.uc.state,
            ...
            l = r4.manualWalletsTemplate(),
            a = r4.recomendedWalletsTemplate(!0);
          o &&
            ((l = l.filter(({ values: e }) =>
          ...
          return H`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
            this
          )}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${ev(
            s
      ...
      (i5.styles = [tP.globalCss, iJ]),
        i2([eu()], i5.prototype, "loading", 2),
        i2([eu()], i5.prototype, "firstFetch", 2),
        i2([eu()], i5.prototype, "search", 2),
        i2([eu()], i5.prototype, "endReached", 2),
        (i5 = i2([ed("wcm-wallet-explorer-view")], i5));
      let i3 = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var i4 = Object.defineProperty,
        i7 = Object.getOwnPropertyDescriptor,
        i6 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i7(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && i4(t, r, l), l;
        };
      let i8 = class extends es {
        ...
        render() {
          let { name: e, id: t, image_id: r } = eA.zv.getWalletRouterData(),
            { isMobile: i, isDesktop: o } = re.getCachedRouterWalletPlatforms(),
            l = eA.zv.isMobile();
          return H`<wcm-modal-header title="${e}" .onAction="${
            re.handleUriCopy
          }" .actionIcon="${
      ...
      (i8.styles = [tP.globalCss, i3]),
        i6([eu()], i8.prototype, "isError", 2),
        (i8 = i6([ed("wcm-web-connecting-view")], i8));
    },
  },
]);
